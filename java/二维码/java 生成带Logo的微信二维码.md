...
###### 1、导入jar包，用的是google的zxing,此次用的是3.3.0版本
...
（1）辅助类：BufferedImageLuminanceSource.java

```java
package com.shaopan.utils.QRCode;
...
```java
  @Test
    public void contextLoads() {
        // 存放在二维码中的内容
        String text = "http://testwx.jhsmk.com.cn/wx/account/toLogin?key=lcULJIPmjgBBbjmxfSWA/CLvvJSgNSbMuNq25Hi/sKk=";
        // 嵌入二维码的图片路径
        String imgPath = "F:\\test\\QRCode\\favicon.png";
        // 生成的二维码的路径及名称
        String destPath = "F:/test/QRCode/qr.jpg";
        try {
            //生成二维码
